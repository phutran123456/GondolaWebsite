...
export class BecomePartnerPage {
    constructor() {
        this._BecomePartnerPageUrl = "https://stage1.testarchitect.com/company/partners/become-a-partner";
    }
    ...
    @action("open Become Partner form", "Navigate to Become Partner page")
    ...
    @action(" input valid information")
    public async inputfields(){
        ...
        await this.clickorOpenLink(this.btSubmit);
       // thank you page displayed
       // await gondola.wait(3);
      //  await gondola.waitForElement(this.lbThankyou,30);
       // await gondola.checkControlExist(this.lbThankyou);
    }
