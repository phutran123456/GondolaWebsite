...
let reminderPage = class reminderPage {
    ...
    async checkMaximumNumberResendActive() {
        await gondolajs_1.gondola.enter(this.txtEmail, datatest_1.datatest.username_inactive);
        let i = 1;
        while (i <= 4) {
            await gondolajs_1.gondola.waitForElement(this.btResendActiveEmail, 30);
